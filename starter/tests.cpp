...
void B_rehash_correctness_by_time() {
    ...
    */
    ...
    int trials = 100000;           // increase if necessary, Central Limit Theorem!
...
//    for (int i = 0; i < 6; i++){
//        std:: cout << "bucket_times_6[" << i << "] = " << bucket_times_6[i] << endl;
//    }
...
//    for (int i = 0; i < 3; i++){
//        std:: cout << "bucket_times_3[" << i << "] = " << bucket_times_3[i] << endl;
//    }
...
//    std::cout << "ratio6_10 = " << ratio6_10 << std::endl;
//    std::cout << "ratio6_23 = " << ratio6_23 << std::endl;
//    std::cout << "ratio6_54 = " << ratio6_54 << std::endl;
...
void C_equality_operator() {
    ...
    VERIFY_TRUE(map1 == map1 , __LINE__);
    VERIFY_TRUE(map2 == map2 , __LINE__);
...
//    copy_assigned.debug();
    ...
    map.erase("A");
    std::cout << copy_assigned.contains("A") << copy_constructed.contains("A");
